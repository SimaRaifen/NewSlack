...
__exportStar(__nccwpck_require__(3616), exports);
...
const is_stream_1 = __importDefault(__nccwpck_require__(7209));
const p_queue_1 = __importDefault(__nccwpck_require__(4850));
const p_retry_1 = __importStar(__nccwpck_require__(2570));
const axios_1 = __importDefault(__nccwpck_require__(7129));
// eslint-disable-next-line @typescript-eslint/naming-convention
const form_data_1 = __importDefault(__nccwpck_require__(1210));
const is_electron_1 = __importDefault(__nccwpck_require__(9246));
const methods_1 = __nccwpck_require__(2583);
const instrument_1 = __nccwpck_require__(3263);
const errors_1 = __nccwpck_require__(1822);
const logger_1 = __nccwpck_require__(9524);
const retry_policies_1 = __nccwpck_require__(4662);
const helpers_1 = __importDefault(__nccwpck_require__(1856));
const file_upload_1 = __nccwpck_require__(8649);
/*
 * Helpers
 */
...
var WebClient_1 = __nccwpck_require__(212);
...
const os = __importStar(__nccwpck_require__(9563));
const path_1 = __nccwpck_require__(1017);
...
const logger_1 = __nccwpck_require__(9778);
var logger_2 = __nccwpck_require__(9778);
...
const eventemitter3_1 = __nccwpck_require__(1948);
const WebClient_1 = __nccwpck_require__(212);
/**
...
__exportStar(__nccwpck_require__(3390), exports);
...
module.exports =
{
  parallel      : __nccwpck_require__(7297),
  serial        : __nccwpck_require__(1377),
  serialOrdered : __nccwpck_require__(9889)
};
...
var defer = __nccwpck_require__(2037);
...
var async = __nccwpck_require__(241)
  , abort = __nccwpck_require__(4797)
  ;
...
var abort = __nccwpck_require__(4797)
  , async = __nccwpck_require__(241)
  ;
...
var iterate    = __nccwpck_require__(6341)
  , initState  = __nccwpck_require__(5556)
  , terminator = __nccwpck_require__(8266)
  ;
...
var serialOrdered = __nccwpck_require__(9889);
...
var DelayedStream = __nccwpck_require__(2310);
...
(function () {
  (__nccwpck_require__(951).config)(
    Object.assign(
      {},
      __nccwpck_require__(3772),
      __nccwpck_require__(677)(process.argv)
    )
  )
})()
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __nccwpck_require__(596)("follow-redirects");
    }
    catch (error) { /* */ }
...
var debug = __nccwpck_require__(1082);
...
var CombinedStream = __nccwpck_require__(1630);
var util = __nccwpck_require__(3837);
...
var Stream = (__nccwpck_require__(2781).Stream);
var mime = __nccwpck_require__(573);
var asynckit = __nccwpck_require__(4084);
var populate = __nccwpck_require__(8959);
...
var db = __nccwpck_require__(5328)
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const EventEmitter = __nccwpck_require__(14);
const p_timeout_1 = __nccwpck_require__(1544);
const priority_queue_1 = __nccwpck_require__(6971);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const lower_bound_1 = __nccwpck_require__(9749);
class PriorityQueue {
    constructor() {
        this._queue = [];
    }
...
const retry = __nccwpck_require__(5856);
...
const pFinally = __nccwpck_require__(7517);
...
var RetryOperation = __nccwpck_require__(3554);
...
const FormData$1 = __nccwpck_require__(1210);
const url = __nccwpck_require__(7310);
const proxyFromEnv = __nccwpck_require__(443);
const http = __nccwpck_require__(3685);
const https = __nccwpck_require__(5687);
const util = __nccwpck_require__(3837);
const followRedirects = __nccwpck_require__(296);
...
/* harmony export */   "Z": () => (/* binding */ Conversation)
/* harmony export */ });
/* harmony import */ var _slack_web_api__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(9606);
/* harmony import */ var dotenv_config__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(238);
...
class Conversation {
    ...
    constructor(channelId, useId) {
        ...
        this.userId = useId;
        this.client = new _slack_web_api__WEBPACK_IMPORTED_MODULE_0__.WebClient(process.env.B_TOKEN, {
            logLevel:_slack_web_api__WEBPACK_IMPORTED_MODULE_0__.LogLevel.DEBUG
        });
    }
